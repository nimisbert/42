...
main = toFile def "./plots/task41.png" $ do
    ...
    plot (line "rate=0.0" [ growth00 [0,(0.1).. 5] ])
    plot (line "rate=0.5" [ growth05 [0,(0.1).. 5] ])
    plot (line "rate=1.0" [ growth10 [0,(0.1).. 5] ])
    plot (line "rate=1.5" [ growth15 [0,(0.1).. 5] ])
    plot (line "rate=2.0" [ growth20 [0,(0.1).. 5] ])
    where
